	...
	<div class="row">
		<div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
			<div class="widget am-cf">
				<div class="widget-head am-cf">
					<div class="widget-title am-cf">组合特惠列表</div>
					<div style='    margin-top: 20px;z-index:22' class="am-u-sm-24 am-u-md-24 am-u-lg-24">
						<div class="am-form-group">
							<button type="button" class="am-btn am-btn-primary" data-am-modal="{target: '#doc-modal-1', closeViaDimmer: 0, width: 600, height: 720}">
								新增组合特惠
							</button>
						</div>
					</div>
		...
		<div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-1">
			<div class="am-modal-dialog">
				<div class="am-modal-hd">新增组合特惠
					<a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
				</div>
				<div class="am-modal-bd">
					<form id='my-form1' action="/index.php?s=/store/games.games_zh/add" class="am-form">
						<fieldset>
							<div class="am-form-group">
...
<script src="assets/store/plugins/umeditor/umeditor.min.js"></script>
	<script>
		$(function() {
			...
			// 删除元素
			var url1 = "<?= url('games.games_zh/delete') ?>";
			$('.item-delete').delete('game_id', url1);


			var url = "<?= url('games.games_zh/update') ?>";
