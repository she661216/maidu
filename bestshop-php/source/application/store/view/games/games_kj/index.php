	...
	<div class="row">
		...
		<div class="am-modal am-modal-no-btn" tabindex="-1" id="doc-modal-1">
			<div class="am-modal-dialog">
				<div class="am-modal-hd">新增砍价活动
					<a href="javascript: void(0)" class="am-close am-close-spin" data-am-modal-close>&times;</a>
				</div>
				<div class="am-modal-bd">
					<form id='my-form1' action="/index.php?s=/store/games.games_kj/add" class="am-form">
						<fieldset>
							<div class="am-form-group">
							...
							<div class="am-form-group">
								<label for="doc-select-1">选择砍价模板：</label>
								<select name='data[goods_id]' id="doc-select-1" required style='    width: 80%;    float: left;    margin-bottom: 15px;'>
...
<script src="assets/store/plugins/umeditor/umeditor.min.js"></script>
	<script>
		$(function() {
			...
			// 删除元素
	var url1 = "<?= url('games.games_kj/delete') ?>";
			$('.item-delete').delete('game_id', url1);


	var url = "<?= url('games.games_kj/update') ?>";
